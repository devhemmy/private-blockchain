...
class Blockchain {
    ...
    _addBlock(block) {
        ...
        self.height++;
        resolve(block)
        reject('somthing went wrong, couldnt add block');
        });
    }
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (currentTime < (messageTime + (5 * 60 * 1000))) {
                ...
                if (isValid) {
                    ...
                    reject('Error:Not valid signature')
                }
            } else {
                reject('you can add a star only once every 5 mins')
            }
        });
    }
    ...
    getBlockByHash(hash) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (block !== undefined) {
                ...
                reject('Error: Could not find a block with that hash!')
            }
        });
    }
